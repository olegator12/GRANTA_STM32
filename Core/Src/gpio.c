...
void MX_GPIO_Init(void)
{
  ...
  GPIO_InitStruct.Pin = PEDAL_BUTTON_CLUTCH_FINISH_Pin|PEDAL_BUTTON_BRAKE_START_Pin|PEDAL_BUTTON_GAS_START_Pin|PEDAL_BUTTON_GAS_FINISH_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = PEDAL_BUTTON_CLUTCH_START_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
