...
#define MOTOR_GAS_RIGHT_PWM_Pin GPIO_PIN_5
#define MOTOR_GAS_RIGHT_PWM_GPIO_Port GPIOE
#define MOTOR_GAS_LEFT_PWM_Pin GPIO_PIN_6
...
#define ENCODER_GAS_B_Pin GPIO_PIN_9
#define ENCODER_GAS_B_GPIO_Port GPIOE
#define ENCODER_GAS_A_Pin GPIO_PIN_11
#define ENCODER_GAS_A_GPIO_Port GPIOE
...
#define ENCODER_CLUTCH_B_Pin GPIO_PIN_6
#define ENCODER_CLUTCH_B_GPIO_Port GPIOC
#define ENCODER_CLUTCH_A_Pin GPIO_PIN_7
#define ENCODER_CLUTCH_A_GPIO_Port GPIOC
#define ENCODER_BRAKE_B_Pin GPIO_PIN_15
#define ENCODER_BRAKE_B_GPIO_Port GPIOA
#define FRONT_BUTTON_Pin GPIO_PIN_0
#define FRONT_BUTTON_GPIO_Port GPIOD
#define FRONT_BUTTON_EXTI_IRQn EXTI0_IRQn
#define BACK_BUTTON_Pin GPIO_PIN_1
#define BACK_BUTTON_GPIO_Port GPIOD
#define BACK_BUTTON_EXTI_IRQn EXTI1_IRQn
...
#define ENCODER_BRAKE_A_Pin GPIO_PIN_3
#define ENCODER_BRAKE_A_GPIO_Port GPIOB
